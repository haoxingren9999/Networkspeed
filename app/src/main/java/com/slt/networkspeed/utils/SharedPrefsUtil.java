...
public class SharedPrefsUtil {
    ...
    public static final String   AUTOHIDE ="autohide";//自动隐藏开关
    public static final String   FRESH_TIME ="fresh_time";//刷新时间
    public static final String   SPEED_UNIT ="speed_unit";//速度单位
    public static final String   IS_NOT_0 ="is_not_0";//流量大于0的时候的20秒时间
